...
# This function is responsible for saving the state of the operation.
...
cmd_sync() {
    ...
    # Second pass: Rebase the remaining (unmerged) stack.
    # We no longer update parentage here; we do it after the rebase succeeds.
